...
def manual_feedback_input(feedback_text):
    ...
    "brand": {
        ...
        "montblanc": ["MONTBLANC"],
        "bibiem": ["BIBIEM"],
        "laurence paul": ["LAURENCE PAUL"],
        "lash": ["LASH"],
        "금자안경": ["금자안경", "GEUMJA"],
        "ash compact": ["ASH COMPACT"],
        "yuihi toyama": ["YUIHI TOYAMA"],
        ...
        "tvr": ["TVR"],
        "lunor": ["LUNOR"],
        "kame mannen": ["KAME MANNEN"],
        "buddy optical": ["BUDDY OPTICAL"],
        ...
        "rawrow": ["RAWROW"],
        "weareannu": ["WEAREANNU"],
        "museum by beacon": ["MUSEUM BY BEACON"],
        "drain your pocket money": ["DRAIN YOUR POCKET MONEY"],
        "fake me": ["페이크 미", "FAKE ME"],
    },
    "size": {
